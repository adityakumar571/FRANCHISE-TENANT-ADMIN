  ...
  return (
    <div ref={ref} style={{ fontFamily:FONT, background:'#fff', color:'#1e293b', padding:'44px 52px', maxWidth:760, margin:'0 auto' }}>
      ...
      <div style={{ marginBottom:36 }}>
        <img src={logoImg} alt="FranchiseCloudX" style={{ height:46, objectFit:'contain', display:'block' }} />
      </div>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:40, marginBottom:40 }}>
        ...
        <div>
          ...
          {invoice.school?.subdomain && <div style={{ fontSize:12, color:'#475569', marginBottom:2 }}>{invoice.school.subdomain}.FranchiseCloudX.com</div>}
        ...
        <div>
          ...
          <div style={{ fontSize:13, fontWeight:700, color:'#0f172a', marginBottom:6 }}>FranchiseCloudX</div>
          {[
            ['Email',    'support@FranchiseCloudX.com'],
            ['Website',  'FranchiseCloudX.com'],
      ...
      <div style={{ marginTop:40, paddingTop:16, borderTop:'1px solid #f1f5f9' }}>
        <p style={{ fontSize:11, color:'#94a3b8', lineHeight:1.7, margin:0 }}>
          For any billing queries, please contact us at <strong>support@FranchiseCloudX.com</strong>.<br/>
          Generated by FranchiseCloudX · {dayjs(invoice.invoiceDate).format('DD MMM YYYY, hh:mm A')} · {invoice.invoiceNumber}
        </p>
      </div>
...
const InvoiceModal = ({ open, billId, onClose }) => {
  ...
  const handleDownloadPDF = () => {
    ...
    doc.text('FranchiseCloudX', M+14, 58)
    ...
    doc.text(invoice.school?.name||'—', M, 122); doc.text('FranchiseCloudX', W/2+10, 122)
    doc.setFont('helvetica','normal'); doc.setFontSize(9); doc.setTextColor(71,85,105)
    let ty = 133
    if (invoice.school?.subdomain) { doc.text(`${invoice.school.subdomain}.FranchiseCloudX.com`, M, ty); ty+=11 }
    ...
    let fy2 = 133
    ;[['Email','support@FranchiseCloudX.com'],['Website','FranchiseCloudX.com']].forEach(([l,v])=>{
    ...
    doc.text('For billing queries: support@FranchiseCloudX.com', M, 820)
