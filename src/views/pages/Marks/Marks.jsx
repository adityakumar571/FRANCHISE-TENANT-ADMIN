          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-200 text-gray-700">
              <tr>
                ...
                <th className="px-3 py-2 text-sm text-center">Student Name</th>
                <th className="px-3 py-2 text-sm text-center">Class</th>
                <th className="px-3 py-2 text-sm text-center">Section</th>
                <th className="px-3 py-2 text-sm text-center">Streams</th>
                <th className="px-3 py-2 text-sm text-center">Obtained Marks</th>
                <th className="px-3 py-2 text-sm text-center">Total Marks</th>
                <th className="px-3 py-2 text-sm text-center">Percentage</th>
                <th className="px-3 py-2 text-sm text-center">Result Status</th>
                <th className="px-3 py-2 text-sm text-center">Action</th>
              </tr>
            </thead>
